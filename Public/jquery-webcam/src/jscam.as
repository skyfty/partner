...
class JSCam {
	...
	private static var camera_width = 600;
	private static var camera_height = 450;
	...
	public static function main():Void {
		...
		if (null != camera) {
			...
			camera.setQuality(600, 450);
			camera.setMode(camera_width, camera_height, 30);
			...
			_root.video._x = 0;
			_root.video._y = 0;
			_root.video.width = camera_width;
            _root.video.height = camera_height;
