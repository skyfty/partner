...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
            $this->upPageUrl = str_replace('__PAGE__',$upRow,$url);
            $this->upPage     =   "<a href='".$this->upPageUrl."'>".$this->config['prev']."</a>";
        }else{
            $this->upPage     =   '';
        }

        if ($downRow <= $this->totalPages){
            $this->downPageUrl = str_replace('__PAGE__',$downRow,$url);
            $this->downPage   =   "<a href='".$this->downPageUrl."'>".$this->config['next']."</a>";
        }else{
            $this->downPage   =   '';
        }
        // << < > >>
        ...
        $pageStr     =   str_replace(
            ...
            array($this->config['header'],$this->nowPage,$this->totalRows,$this->totalPages,$this->upPage,$this->downPage,$theFirst,$prePage,$linkPage,$nextPage,$theEnd),$this->config['theme']);
        return $pageStr;
    }
