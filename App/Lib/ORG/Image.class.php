...
{//类定义开始
	...
	static public  function watermark($source,$target = '',$config ) {
		...
		if($config['watermark_img'])$w_img = './Public/img/'.$config['watermark_img'];
		$w_text = $config['watemard_text'];
		$w_font =  $config['watemard_text_size'];
		$w_color =  $config['watemard_text_color'];
		$fontface =  './Public/img/font/'.$config['watemard_text_face'];
    ...
    static function imageCreateFromBMP($filePath)
    {
