<?php
	class CultivateChannelProductViewModel extends ViewModel {
        public $viewFields;
		public function _initialize(){
            ...
            $model_field['_on'] = 'product.product_id = cultivate_channel.channel_model_id';
            ...
            $this->viewFields = array(
                ...
                'product_category'=>array(
                    ...
                    "serve_modality",
                    '_on'=>'cultivate.category_id=product_category.category_id',
                    '_type'=>'LEFT'
                )
            );
		}
