...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="<?php echo (__APP__); ?>" alt="<?php echo defaultinfo('description');?>">
                <?php echo defaultinfo('name');?>
            </a>
		</div>
	</div>
</div>
	...
	<div class="row">
		...
		<div class="span4">
		  <div style="border-left:1px solid #eee;"><form action="" method="post" class="form-signin">
              <span style="float:left;font-size:19px;padding-bottom:8px;">系统开发部张晓：18810561239</span>

              <fieldset>
			<legend><h3><?php echo L('USER_LOGIN');?></h3></legend>
			...
			<br/>
			<input name="submit" class="btn btn-primary" type="submit" value="<?php echo L('LOGIN');?>"/>
            </fieldset>
		  </form>
