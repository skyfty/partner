...
<div class="page-header" style="border:none; ">
    ...
    <a  href="<?php echo U('market/index');?>"><img src="__PUBLIC__/img/shangji.png"/>&nbsp;订单列表
        ...
        <ul id="sddm" style="margin:0px 0px 0px 0px">
            ...
            <li>
                ...
                <div  id="create_time" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                    ...
                    <?php echo create_time_desc('fmonth');?>
                    </a>
            ...
            <li>
                &nbsp;<a  <?php if(($_GET['evaluate_state']== '已评') and ($_GET['survey_state']== 'none')): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'evaluate_state=&survey_state=');?>" class="active"<?php else: ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'survey_state=none&evaluate_state=已评');?>"<?php endif; ?>>
                待回访
                </a>

            </li>
            <li>
                &nbsp;<a  <?php if(($_GET['asid']== '3') and ($_GET['asids']== '1,2,3,4,5') and ($_GET['evaluate_state']== '未评')): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'asid=&asids=&evaluate_state=');?>" class="active"<?php else: ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'asid=3&asids=1,2,3,4,5&evaluate_state=未评');?>"<?php endif; ?>>
                待评价
                </a>
        ...
        <div class="pull-left">
            <form class="form-inline" id="searchForm" action="<?php echo U('');?>" method="get">
                <ul class="nav pull-left">
                    ...
                    <li class="pull-left">
                        <?php if($Think.get.sid): ?><input type="hidden" name="sid" value="<?php echo ($_GET['sid']); ?>"><?php endif; ?>
                        <?php if($Think.get.sids): ?><input type="hidden" name="sids" value="<?php echo ($_GET['sids']); ?>"><?php endif; ?>
                        <ul class="nav pull-left">
                            <li class="pull-left">
...
<script>
    ...
    $(function() {
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                <a class="btn btn-mini btn-primary" href="<?php echo U('market/add');?>"  target="_blank">
                ...
                <ul class="dropdown-menu  pull-right">
                    ...
                    <?php if(vali_permission('market', 'export')): ?><li>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <?php if($vo['field'] == 'category_id'): if($_GET['asc_order'] == $vo['field']): ?><a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
    ...
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <div  id="category_list" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                ...
                <?php if(is_array($category_list)): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['category_id']== $vo['category_id'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'category_id=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'category_id='.$vo['category_id']);?>"<?php endif; ?>>
                    <?php echo ($vo['name']); ?>
                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <div id="owner_role_id" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                ...
                <?php $_result=market_owner_staff_list($category_id, $branch, $asids, $ssids);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['owner_role_id']== $vo['role_id'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'owner_role_id=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'owner_role_id='.$vo['role_id']);?>"<?php endif; ?>>
                    <?php echo ($vo['name']); ?>
                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        <?php elseif($vo['field'] == 'survey_state'): ?>
            <?php if($_GET['asc_order'] == $vo['field']): ?><a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?> &nbsp;<img src="__PUBLIC__/img/arrow_up.png">
    </a>
<?php elseif($_GET['desc_order'] == $vo['field']): ?>
...
<?php else: ?>
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <a onmouseover="mopen('survey_state')" onmouseout="mclosetime()"  href="javascript:void(0);" id="survey_state_filter">
                <i class="icon-filter"></i>
            </a>
            <?php if(($_GET['survey_state']!= '')): ?><br/><span style="font-weight:normal"><?php echo ($_GET['survey_state']); ?></span><?php endif; ?>
            <div id="survey_state" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                <a <?php if(($_GET['survey_state']== '')): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'survey_state=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'survey_state=');?>"<?php endif; ?>>
                全部
                </a>
                <?php $_result=model_select_field_list(982);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['survey_state']== $vo)): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'survey_state=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'survey_state='.$vo);?>"<?php endif; ?>>
                    <?php echo ($vo); ?>
                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        <?php elseif($vo['field'] == 'evaluate_state'): ?>
            <?php if($_GET['asc_order'] == $vo['field']): ?><a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?> &nbsp;<img src="__PUBLIC__/img/arrow_up.png">
    </a>
<?php elseif($_GET['desc_order'] == $vo['field']): ?>
...
<?php else: ?>
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <a onmouseover="mopen('evaluate_state')" onmouseout="mclosetime()"  href="javascript:void(0);" id="evaluate_state_filter">
                <i class="icon-filter"></i>
            </a>
            <?php if(($_GET['evaluate_state']!= '')): ?><br/><span style="font-weight:normal"><?php echo ($_GET['evaluate_state']); ?></span><?php endif; ?>
            <div id="evaluate_state" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                <a <?php if(($_GET['evaluate_state']== '')): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'evaluate_state=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'evaluate_state=');?>"<?php endif; ?>>
                全部
                </a>
                <?php $_result=model_select_field_list(981);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['evaluate_state']== $vo)): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'evaluate_state=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'evaluate_state='.$vo);?>"<?php endif; ?>>
                    <?php echo ($vo); ?>
                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
...
<?php else: ?>
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <a onmouseover="mopen('list_header_status_id')" onmouseout="mclosetime()"  href="javascript:void(0);" id="status_id_filter">
                <i class="icon-filter"></i>
            </a>

            <?php if($status_list['as']['csid']): ?><br/><span style="font-weight:normal">
                <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asids=&asid=');?>" style="color: darkmagenta"  class="active">[<?php echo ($status_list['as']['csid']['name']); ?>]</a>
                </span><?php endif; ?>

            <div id="list_header_status_id" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                <a <?php if(($_GET['asids']== $status_list['as']['sid'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'asids=&asid=');?>" class="active"<?php else: ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'asids='.$status_list['as']['sid'].'&asid=');?>"<?php endif; ?>>
                全部
                </a>
                <?php if(is_array($status_list['as']['slist'])): $i = 0; $__LIST__ = $status_list['as']['slist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['asid']== $vo['status_id'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'asid=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'asid='.$vo['status_id'].'&asids='.$status_list['as']['sid']);?>"<?php endif; ?>>
                    <?php echo ($vo['name']); ?>
        ...
        <?php elseif($vo['field'] == 'settle_state'): ?>
            <?php if($_GET['asc_order'] == $vo['field']): ?><a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?> &nbsp;<img src="__PUBLIC__/img/arrow_up.png">
    </a>
<?php elseif($_GET['desc_order'] == $vo['field']): ?>
...
<?php else: ?>
    <a href="<?php echo U('');?>&<?php echo FP($parameter, 'asc_order=&desc_order='.$vo['field']);?>"  title="<?php echo ($vo["link_title"]); ?>">
        <?php echo ($vo["name"]); ?>
            ...
            <a onmouseover="mopen('list_header_settle_state')" onmouseout="mclosetime()"  href="javascript:void(0);" id="settle_state_filter">
                <i class="icon-filter"></i>
            </a>

           <?php if($status_list['ss']['csid']): ?><br/><span style="font-weight:normal">
               <a href="<?php echo U('');?>&<?php echo FP($parameter, 'ssids=&ssid=');?>" style="color: darkmagenta"  class="active">[<?php echo ($status_list['ss']['csid']['name']); ?>]</a>
                </span><?php endif; ?>

            <div id="list_header_settle_state" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                <a <?php if(($_GET['ssids']== $status_list['ss']['sid'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'ssids=&ssid=');?>" class="active"<?php else: ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'ssids='.$status_list['ss']['sid'].'&ssid=');?>"<?php endif; ?>>
                全部
                </a>
                <?php if(is_array($status_list['ss']['slist'])): $i = 0; $__LIST__ = $status_list['ss']['slist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if(($_GET['ssid']== $vo['status_id'])): ?>href="<?php echo U('');?>&<?php echo FP($parameter, 'ssid=');?>" class="active"<?php else: ?> href="<?php echo U('');?>&<?php echo FP($parameter, 'ssid='.$vo['status_id'].'&ssids='.$status_list['ss']['sid']);?>"<?php endif; ?>>
                    <?php echo ($vo['name']); ?>
...
<script>
    $(function(){
        $.ajax("<?php echo U('Market/make_owner_role_id_list_header');?>")
    });
</script>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td>
                            <input type="checkbox" class="check_list" name="market_id[]" value="<?php echo ($vo["market_id"]); ?>" <?php if(($vo['optstate']) == "true"): ?>disabled="disabled" optstate="1" <?php else: ?> optstate="0"<?php endif; ?>/>
                            <?php if($vo['promtp_count'] > 0): ?><div style="color: red;float:right" class="animated flash infinite">
                                    <a href="<?php echo U('market/view', 'id='.$vo['market_id'].'&assort=prompt');?>" style="color: red">(<?php echo ($vo['promtp_count']); ?>)</a>
                                </div><?php endif; ?>
                        </td>
         ...
         <?php else: ?>
            <?php echo ($vo[$v['field']]); endif; endif; ?>
                        ...
                        <td style="text-align: center">
                            <?php if($assort == 'xs'): ?><a href="<?php echo U('market/view', 'id='.$vo['market_id']);?>" title="查看详情" style="padding-right:5px"  target="_blank" >
                                <i class="icon-th-large"></i>
                            </a>
                            <?php else: ?>
                                <a href="<?php echo U('market/view', 'assort=cost&id='.$vo['market_id']);?>" style="padding-right:5px" title="结算详情"  target="_blank" >
                                    <i class="icon-calendar"></i>
                                </a><?php endif; ?>

                            <?php if($assort == 'cb'): if($vo['market_settle']): ?><a href="<?php echo U('market/settlement', 'id='.$vo['market_id']);?>" style="padding-right:5px" title="结算订单"  class="settlement_btn">
                            ...
                            <?php else: ?>
                                <?php if($vo['per_edit'] and $vo['market_over'] and $vo['status_id'] != '0' and $vo['settle_state'] < 917): ?><a href="<?php echo U('market/submit_settlement', 'id='.$vo['market_id']);?>" title="提交结算" style="padding-right:5px"  class="submit_settlement_btn">
...
<script>
    $("#advanced_dosearch").click(function(){
        advsearch('<?php echo U("Market/search");?>');
    });
</script>
...
<script>
    function changeContent(){
        ...
        window.location.href="<?php echo U('market/index', 'by=');?>"+a;
    }

    $(function(){
        $('#delete').click(function(){
            art.dialog.confirm('确定要删除这些订单吗？', function(){
                $("#form1").attr('action', '<?php echo U("market/delete");?>');
                $("#form1").submit();
            });
        });
            ...
            $(this).qtip({
                content: {
                    text: function(event, api) {
                        ...
                        $.ajax({
                            url: "<?php echo U('market/getmarketproduct');?>&market_id=" + market_id
                        })
