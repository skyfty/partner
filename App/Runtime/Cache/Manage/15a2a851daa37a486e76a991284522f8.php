	...
	<div class="row">
		<div class="span12">
			...
			<form action="" method="post"  enctype="multipart/form-data">
			    <input type="hidden" name="role_id" value="<?php echo (session('user_id')); ?>"/>
                <table class="table table-hover">
    <thead>
    <tr>
        <td style="text-align: center" colspan="4">
            <input name="submit" class="btn btn-primary" type="submit" value="<?php echo L('SAVE');?>"/> &nbsp;
            <input class="btn" type="reset" onclick="on_click_return();" value="<?php echo L('RETURN');?>"/>
        </td>
    </tr>
    </thead>
    <tfoot>
...
<script>
    ...
    <?php if($refer_url != ''): ?>location.assign('<?php echo ($refer_url); ?>');
    <?php else: ?>
