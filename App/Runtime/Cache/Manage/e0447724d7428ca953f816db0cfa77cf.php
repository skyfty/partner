...
<table class="table" id="market-data-table">
    ...
    <tbody>
    <?php if(is_array($product["market"])): $i = 0; $__LIST__ = $product["market"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <?php if(is_hide_field($vo[$v['field']])): echo ($vo[$v['field']]); ?>
         <?php else: ?>
            ...
            <td style="text-align: center">
                <a href="<?php echo U('market/view', 'id='.$vo['market_id']);?>" title="查看详情"  target="_blank" >
