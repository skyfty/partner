...
<div class="container">
    ...
    <li  <?php if((MODULE_NAME) == "Trade"): if((ACTION_NAME) == "index"): ?>class="active"<?php endif; endif; ?>>
    <a href="<?php echo U('trade/index');?>"><img src="__PUBLIC__/img/cares_icon.png"/> &nbsp;产品订单<?php if($module_group != null): ?>[<?php echo ($module_group['type_name']); ?>： <?php echo ($module_group['name']); ?><i class="icon-remove remove-group"  style="color: red"></i>]<?php endif; ?></a>
    </li>
    <li <?php if((MODULE_NAME) == "Serve"): ?>class="active"<?php endif; ?>>
    <a  href="<?php echo U('serve/index');?>"><img src="__PUBLIC__/img/customer_icon.png"/>&nbsp; 产品列表</a>
    </li>

    <li  <?php if((MODULE_NAME) == "Trade"): if((ACTION_NAME) == "cost"): ?>class="active"<?php endif; endif; ?>>
    <a href="<?php echo U('trade/cost');?>"><img src="__PUBLIC__/img/caigou.png"/> &nbsp;成本</a>
    </li>
</ul>
    </div>
    <p class="view">
        ...
        <i class="icon-time"></i>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=today');?>" <?php if($_GET['by']== 'today'): ?>class="active"<?php endif; ?>><?php echo L('TODAY_IS_NEW');?></a>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=fmonth');?>" <?php if($_GET['by']== 'fmonth'): ?>class="active"<?php endif; ?>>上月新建</a>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=month');?>" <?php if($_GET['by']== 'month'): ?>class="active"<?php endif; ?>><?php echo L('THIS_MONTH_THE_NEW');?></a>

        <i class="icon-check"></i>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=cx');?>" <?php if($_GET['by']== 'cx'): ?>class="active"<?php endif; ?>>已撤销</a>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=dk');?>" <?php if($_GET['by']== 'dk'): ?>class="active"<?php endif; ?> >待开始</a>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=jx');?>" <?php if($_GET['by']== 'jx'): ?>class="active"<?php endif; ?>>进行中</a>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=js');?>" <?php if($_GET['by']== 'js'): ?>class="active"<?php endif; ?>>已结束</a>
        <!--<a href="<?php echo U('');?>&<?php echo FP($parameter, 'by=df');?>" <?php if($_GET['by']== 'df'): ?>class="active"<?php endif; ?>>待付款</a>-->
...
<ul class="nav  nav-list">
    <li class="active">
        <a href="<?php echo U('');?>">类别</a>
    </li>
    <?php if(is_array($serve_category)): $i = 0; $__LIST__ = $serve_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><li>
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'cat='.$cat['serve_category_id']);?>" <?php if($focus_category['serve_category_id'] == $cat['serve_category_id']): ?>class="active"<?php endif; ?>>
            <?php echo ($cat['name']); ?>
        </a>
        </li><?php endforeach; endif; else: echo "" ;endif; ?>
    <li class="active">
        <a href="<?php echo U('');?>&<?php echo FP($parameter, 'act=group');?>">分组</a>
    </li>
</ul>
        ...
        <div class="span11" style="float: right">
            <ul class="breadcrumb">
                <li><a href="<?php echo U('');?>&<?php echo FP($parameter, 'cat=');?>">全部</a> <span class="divider">/</span></li>
                <?php if(is_array($bread_list)): $i = 0; $__LIST__ = $bread_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bread): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('');?>&<?php echo FP($parameter, 'cat='.$bread['serve_category_id']);?>"><?php echo ($bread['name']); ?></a> <span class="divider">/</span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                <li class="active"><?php echo ($focus_category['name']); ?></li>
            </ul>
        </div>
        <div class="span11"  style="float: right">
            <div class="bulk-actions align-left">
                <ul class="nav pull-left">
                    <form class="form-inline" id="searchForm" action="" method="get">
                        <li class="pull-left">
                            <button  id="delete"  type="button" class="btn  btn-danger" style="margin-right: 5px;">
                        ...
                        <li class="pull-left">
                            <?php if(($_GET['trade_group_id']!= null) and ($_GET['group_type']== '1')): ?><div class="btn-group">
                            ...
                            <?php else: ?>
                                <button  id="add_group" type="button"  class="btn" style="margin-right: 5px;">
    ...
    $(function() {
        ...
        <?php if($Think.get.search_census): ?>$("#search_census").prop('value', '<?php echo ($_GET['search_census']); ?>');<?php endif; ?>
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        <a class="btn btn-primary" href="<?php echo U('trade/add');?>"  target="_blank">
                            <i class="icon-plus"></i>&nbsp; 添加订单
                        </a>&nbsp;
...
<?php elseif($vo['form_type'] == 'number' or $vo['form_type'] == 'floatnumber'): ?>
    ...
    <span style="font-weight:normal"><?php echo format_table_head_text_col($vo['field'], $parameter);?></span><?php endif; endif; ?>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td>
                            <input class="check_list" type="checkbox"  trade_name="<?php echo ($vo['category']); ?>" name="trade_id[]" value="<?php echo ($vo["trade_id"]); ?>"/>
                        </td>
        ...
        <?php if(is_hide_field($vo[$v['field']])): echo ($vo[$v['field']]); ?>
         <?php else: ?>
            <?php echo ($vo[$v['field']]); endif; endif; ?>
                        ...
                        <td>
                            <?php if($vo['corre_info'] != null): echo ($vo["corre_info"]); endif; ?>
                        </td>
                        <td>
...
<script>
    $("#advanced_dosearch").click(function(){
        $('#adv-search').dialog('open');
        $('#adv-search').load('<?php echo U("Trade/search");?>');
    });
</script>
    ...
    $(function(){
        ...
        $('#delete').click(function(){
            art.dialog.confirm('确定删除吗?', function () {
                $("#form1").attr('action', '<?php echo U("trade/delete");?>');
                $("#form1").submit();
            });

        });

        $(".trade_group").change(function(){
            var trade_name = $(this).attr("trade_name");
            $("input[trade_name='" +trade_name+ "']").prop('checked', $(this).prop("checked"));
        });
    });
</script>
<script type="text/javascript" src="__PUBLIC__/js/uploadPreview.js"></script>
