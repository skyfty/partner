...
<table class="table" id="cultivate-data-table">
    <thead>
    <tr>
        ...
        <th style="width:40px;text-align: center"><?php echo L('OPERATION');?></th>
    </tr>
    </thead>

    <tbody>
    <?php if(is_array($product["cultivate"])): $i = 0; $__LIST__ = $product["cultivate"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <?php if(is_hide_field($vo[$v['field']])): echo ($vo[$v['field']]); ?>
         <?php else: ?>
            ...
            <td style="text-align: center">
                <a href="<?php echo U('cultivate/view', 'id='.$vo['cultivate_id']);?>" title="查看详情"  target="_blank" >
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cultivate-data-table').dataTable( {
            "scrollX": true,
            "order": [[ 0, "desc" ]],
