...
<div class="container">
	...
	<div class="row">
        ...
        <div class="span12">
                ...
                <input type='hidden' name="byc" <?php if(isset($byc)): ?>value="<?php echo ($byc); ?>"<?php endif; ?>/>
                <input type='hidden' name="cmodel_id" <?php if(isset($cmodel_id)): ?>value="<?php echo ($cmodel_id); ?>"<?php endif; ?>/>
...
<script>
    ...
    <?php if($byc != 'commiss'): ?>function channel_role_model_change() {
...
<script>
    $(function(){
        $("#channel_role_id_name").formValidator({
            tipID:"channel_role_id_nameTip",
            ...
            fun:function(val,elem){
                ...
                if (model == "雇员库" || model == "员工库" ||  model == "客户库") {
                    if (val == "") {
                        return "渠道人不可以为空";
                    }
                }
