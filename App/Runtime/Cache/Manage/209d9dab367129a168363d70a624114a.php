					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<span style="color:red;"><?php echo L('USE_COMMAS_BETWEEN_TYPES');?> </span>
							</td>
						</tr>
						<tr>
                        ...
                        <tr>
                            <td class="tdleft">提醒时间段</td>
                            <td>
                                <input type="text" class="Wdate" name="remind_bt" id="remind_bt" value="<?php echo (todate($defaultinfo["remind_bt"],'H:i')); ?>" onFocus="WdatePicker({dateFmt:'HH:mm'})"/>
                                <input type="text" class="Wdate" name="remind_et" id="remind_et" value="<?php echo (todate($defaultinfo["remind_et"],'H:i')); ?>" onFocus="WdatePicker({dateFmt:'HH:mm'})"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdleft">客服电话</td>
                            <td>
                                <input name="commiss_telephone" id="commiss_telephone" type="text" value="<?php echo ($defaultinfo["commiss_telephone"]); ?>">
                            </td>
                        </tr>
						<tr>
							<td class="tdleft">客服联络时间间隔</td>
							<td>
								<input name="commiss_remind_limit" id="commiss_remind_limit" type="text" value="<?php echo ($defaultinfo["commiss_remind_limit"]); ?>">天
							</td>
						</tr>
                        <!--<tr>-->
                            <!--<td class="tdleft">数据备份</td>-->
                            <!--<td>-->
                                <!--<a id="backup" target="_blank" class="btn btn-default" href="<?php echo U('setting/backup');?>">开始备份</a>-->
                            <!--</td>-->
                        <!--</tr>-->
						<tr>
							<td>&nbsp;</td>  
...
$(function(){
    $('#backup').click(function(){
        return confirm("确实要执行备份吗?\n备份会执行长时间操作， 在这其间请停止操作系统。\r备份完毕后可将备份文件下载到本地保存， 防止丢失。如果长时间没有状态更新， 可尝试稍后刷新页面");
    });
});
</script>
<script type="text/javascript" src="__PUBLIC__/js/uploadPreview.js"></script>
