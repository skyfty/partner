        ...
        <form action="<?php echo U('setting/fielddelete');?>" method="post" onSubmit="return checkForm()">
            <div class="span10">
                ...
                <div class="pull-right">
                    <button class="btn btn-default" type="button" id="fieldsgroup"><i class="icon-plus"></i>&nbsp; 分组管理</button>
            ...
            <div class="tabbable span10">
                <ul class="nav nav-tabs">
                    ...
                    <a href="<?php echo U('setting/product_fields', 'model=product&assort=basic');?>">基本信息</a>
                    </li>
                    <li <?php if($_GET['assort'] == 'skill'): ?>class="active"<?php endif; ?>>
                    <a href="<?php echo U('setting/product_fields', 'model=product&assort=skill');?>">专业技能
                    </a>
                    </li>
                    <li <?php if($_GET['assort'] == 'train'): ?>class="active"<?php endif; ?> >
                    <a href="<?php echo U('setting/product_fields', 'model=product&assort=train');?>">培训信息</a>
                    </li>
                    <li <?php if($_GET['assort'] == 'event'): ?>class="active"<?php endif; ?> >
                    <a href="<?php echo U('setting/product_fields', 'model=product&assort=event');?>">日程</a>
                    </li>
                    <li <?php if($_GET['assort'] == 'evaluate'): ?>class="active"<?php endif; ?> >
                    <a href="<?php echo U('setting/product_fields', 'model=product&assort=evaluate');?>">评价</a>
                    </li>
                </ul>
            </div>
            <div class="span10">
