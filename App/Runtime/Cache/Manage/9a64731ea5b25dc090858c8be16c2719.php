		...
		<div class="span12">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="<?php echo U('league/view', 'id='.$league['league_id']);?>">加盟商详情</a>
                    </li>
                </ul>
            </div>
            <table class="table">
                    ...
                    <tr>
                        <td colspan="4">
                            <p style="font-size: 14px;">
                                <?php if(vali_permission('league','edit')): ?><a href="<?php echo U('league/edit','id='.$league['league_id']);?>">编辑</a> |<?php endif; ?>
                                <?php if(vali_permission('league','delete')): ?><a href="<?php echo U('league/delete','id='.$league['league_id']);?>" class="del_confirm"><?php echo L('DELETE');?></a><?php endif; ?>
                            </p>
                        </td>
                    </tr>
                </thead>
