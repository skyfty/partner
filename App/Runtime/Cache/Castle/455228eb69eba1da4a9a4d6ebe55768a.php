...
<div ng-controller="leadsAssociateController">
    ...
    <div class="row wrapper" style="padding-bottom:0px">
        <div class="table-responsive">
            <table ui-datatable="fields" ng-data-url="leads/index" ng-page="totalPages" ng-create-row="createdRow" ng-row-option="table-row-options" ng-page-length="datatablePageLength" class="table table-striped hover b-t b-light" style="white-space: nowrap;">
                <thead>
                <tr>
                </tr>
                </thead>
...
<script>
    ...
    app.controller('leadsAssociateController', function($scope, multipleSearch) {
        $scope.fields = fields;
