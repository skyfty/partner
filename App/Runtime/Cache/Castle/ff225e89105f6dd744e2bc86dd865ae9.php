...
<div ng-controller="cultivateAssociateController">
    ...
    <div class="row wrapper" style="padding-bottom:0px">
        <div class="table-responsive">
            <table ui-datatable="fields" ng-data-url="cultivate/index" ng-page="totalPages" ng-create-row="createdRow" ng-row-option="table-row-options" ng-page-length="datatablePageLength" class="table table-striped hover b-t b-light" style="white-space: nowrap;">
                <thead>
                <tr>
                </tr>
                </thead>
...
<a id="table-cell-option" target="_blank" href="#/view/cultivate/${cultivate_id}" class="table-cell-option" style="margin-left: 5px"><i class="fa fa-flickr"></i></a>
</script>

<script>
    var fields = <?php echo (json_encode($field_array)); ?>;

    app.controller('cultivateAssociateController', function($scope, multipleSearch) {
        $scope.fields = fields;
        ...
        $scope.datatablesearch = function(d){
            ...
            d['forces'] = {'model':$scope.related_model, 'model_id':$scope.related_model_id};
        };
    });
</script>